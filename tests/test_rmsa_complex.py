import gym
from optical_rl_gym.envs.rmsa_complex_env import shortest_path_first_fit, shortest_available_path_first_fit, \
...
init_env = gym.make('RMSAComplex-v0', **env_args)
...
env_sp = gym.make('RMSAComplex-v0', **env_args)
...
env_sap = gym.make('RMSAComplex-v0', **env_args)
...
env_llp = gym.make('RMSAComplex-v0', **env_args)
