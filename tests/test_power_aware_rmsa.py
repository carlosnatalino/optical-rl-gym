...
from optical_rl_gym.envs.power_aware_rmsa_env import shortest_path_first_fit, shortest_available_path_first_fit, \
    least_loaded_path_first_fit, SimpleMatrixObservation, shortest_available_path_first_fit_fixed_power
...
env_sapfffp = gym.make('PowerAwareRMSA-v0', **env_args)
mean_reward_sp, std_reward_sp = evaluate_heuristic(env_sapfffp, shortest_available_path_first_fit_fixed_power, n_eval_episodes=episodes)
print('SP-FF:'.ljust(8), f'{mean_reward_sp:.4f}  {std_reward_sp:<7.4f}')
print('Bit rate blocking:', (env_sapfffp.episode_bit_rate_requested - env_sapfffp.episode_bit_rate_provisioned) / env_sapfffp.episode_bit_rate_requested)
print('Request blocking:', (env_sapfffp.episode_services_processed - env_sapfffp.episode_services_accepted) / env_sapfffp.episode_services_processed)
